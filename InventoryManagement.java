...
public class InventoryManagement {
    ...
    static Product[] products = {
        new Product("Laptop", "16GB RAM, 512GB SSD, Intel i5 Processor", 900, 20),
        new Product("Smartphone", "6GB RAM, 128GB Storage, Octa-Core Processor", 500, 30),
        new Product("Tab", "4GB RAM, 64GB Storage, Octa-Core Processor", 300, 40)
    };
    ...
    static void viewProductList() {
        ...
        for (int i = 0; i < products.length; i++) {
            System.out.println((i + 1) + ". " + products[i].product_name);
        }
    }
    ...
    static void viewProductCount() {
        ...
        for (int i = 0; i < products.length; i++) {
            if (products[i].product_name.equalsIgnoreCase(productName)) {
    ...
    static void viewProductDetails() {
        ...
        for (int i = 0; i < products.length; i++) {
            if (products[i].product_name.equalsIgnoreCase(productName)) {
            System.out.println("Name: " + products[i].product_name);
